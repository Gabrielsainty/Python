...
if IMC >= 40:
    print (f'Seu IMC deu {IMC:.1f}. Voce está dentro da faixa de obesidade mórbida, o ideal seria procurar um profissional para acompanhar uma rotina de exercícios e alimentação regrada.')

elif IMC >= 30:
    print(f'Voce está obeso, procure realizar uma dieta unida a prática de exercícios físicos. ({IMC:.1f})')
    ...
    print (f'Voce está abaixo do peso. Consulte um profissional para lhe passar uma orientação alimentar melhor.({IMC:.1f})')